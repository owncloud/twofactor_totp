OC.L10N.register(
    ...
    "To enable second-factor verify authentication code below." : "Чтобы включить второй фактор проверьте аутентификационный код ниже.",
    ...
    "Scan the QR code below with your TOTP app and enter the code" : "Отсканируйте QR-код ниже с помощью приложения TOTP и введите его.",
